    ...
    public function run()
    {
        $data = [
            ...
            [
                'code' => 'projects',
                'slug' => 'projects',
                'title' => 'Реалізовані проєкти компанії Mediaservice',
                'description' => 'Реалізовані проєкти компанії Mediaservice',
            ],
            [
                'code' => 'study',
                'slug' => 'study',
