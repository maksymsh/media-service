        ...
        $data = [
            [
                ...
                'stages' => [
                    ...
                    [
                        'title' => 'Передпроєктні роботи',
                        'text' => 'Проведення передпроєктного обстеження підприємтва або експрес-обстеження (аналіз існуючух бізнес-процесів на підприємствах Замовника), формалізація вимог Замовника, аналіз матеріальних та людських ресурсів для забезпечення успішного виконання проєкту, оцінка ризиків, визначення бюджету та термінів реалізації проєкту, екскізне проєктування майбутньої інформаційної системи.',
                    ],
                    [
                    ...
                    [
                        ...
                        'text' => 'Переведення системи в промислову експлуатацію, підведення підсумків проєкту, формальне закриття проєкту, передача проєкту',
                    ],
                    [
                        'title' => 'Супровід',
