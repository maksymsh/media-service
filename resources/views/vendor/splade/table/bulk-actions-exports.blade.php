...
<x-splade-component is="button-with-dropdown" :as="$as" dusk="bulk-actions-exports-dropdown"
    ...
    <div class="">
        <div class="">
            <h3 v-if="table.hasSelectedItems" class="">
            ...
            @if($table->hasExports() && $table->hasBulkActions())
                <div v-if="table.hasSelectedItems" class=""></div>
            @endif
