@if ($paginator->lastPage() > 1)
    <div class="row">
        ...
        <div class="col-12 col-md-6 text-center text-md-end text-muted">
            ...
            <strong>{{ $paginator->count() ? $paginator->firstItem() : 0 }} </strong>
            <span>@lang('to')</span>
            <strong>{{ $paginator->count() ? $paginator->lastItem() : 0 }} </strong>
            <span>@lang('of') </span>
...
{{--                            <svg width="20" height="20" class="" fill="currentColor" viewBox="0 0 20 20">--}}
