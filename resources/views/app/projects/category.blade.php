    ...
    <div class="container-fluid">
        <section class="projects-page header-fix relative">
            ...
            <div class="tabs-menu d-flex align-items-start flex-wrap">
                <x-splade-link :href="$appPages['projects']" class="item">всі галузі</x-splade-link>
                @foreach($categories as $c)
                    <x-splade-link :href="$c->url" class="item {{ $c->id === $category->id ? 'active' : '' }}">{{ $category->name }}</x-splade-link>
                @endforeach
            </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-4">
                            <div class="item d-flex flex-column justify-content-between align-items-start">
                                ...
                                <div class="item-bottom">
                                    ...
                                    <x-splade-link :href="$project->url" class="link-default item-link white d-inline-flex align-items-center">
