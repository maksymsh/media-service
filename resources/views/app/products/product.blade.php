    ...
    <div class="container-fluid">
        <section class="service-detail-page header-fix">
            ...
            <div class="detail-top ">
                <div class="d-lg-flex align-items-center">
                    <div class="breadcrumps  black">
                        <ul class="nav flex-wrap">
                            ...
                            <li>
                                <span class="current">BAS Бухгалтерія</span>
                            </li>
                        </ul>
                    </div>
                ...
                <h1>BAS Бухгалтерія</h1>
                <div class="price">Вартість продукту 6 690 грн.</div>
            </div>
            <div class="detail-info  d-lg-flex justify-content-between">
                <div class="anons order-12">
                    <p>Програмний продукт "BAS Бухгалтерія" є призначеним для автоматизації бухгалтерського і
                        ...
                        Бухгалтерський та податковий облік ведеться відповідно до чинного законодавства України.</p>
                    ...
                    <div class="for-menus">
                        <div class="solutions-item solutions-item--solution" id="menu-1">
                            ...
                            <p>"BAS Бухгалтерія" забезпечує вирішення всіх завдань, що стоять перед бухгалтерською
