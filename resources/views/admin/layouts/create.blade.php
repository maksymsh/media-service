...
@section('content')
    <x-admin.layout.page :breadcrumbs="[
        ...
        ['title' => '#' . $layout->id, 'url' => route('admin.layouts.create', $layout)],
    ]">

        <x-slot:header>
                <h1>{{ __('Create') }} {{ __('Layout') }}</h1>
        ...
        <div>
            <x-splade-form :default="$layout" method="POST" :action="route('admin.layouts.store')">
